...
namespace Trening2
{
    class Program
    {
        ...
        class EnterAnswer
        {
            ...
            {
                Test testPath = new Test(@"C:\Users\Ангелина\OneDrive\Desktop\trening2\биология\Методы исселдования в биологии.txt");
                Answer answerPath = new Answer(@"C:\Users\Ангелина\OneDrive\Desktop\trening2\биология\ответы.txt");
                ...
                reader.Content();
                SaveResult.SaveTestResult(@"C:\Users\Ангелина\OneDrive\Desktop\trening2\биология\результаты.txt", name._Name,  reader._Result, reader._Finish);
